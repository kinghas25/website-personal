...
INSERT INTO `bom_produk` (`kode_bom`, `kode_bk`, `kode_tempat`, `nama_produk`, `kebutuhan`) VALUES
...
INSERT INTO `inventory` (`kode_bk`, `nama`, `qty`, `satuan`, `no_hp`, `tanggal`) VALUES
...
INSERT INTO `produk` (`kode_tempat`, `nama`, `image`, `deskripsi`, `no_hp`) VALUES
...
INSERT INTO `produksi` (`id_order`, `invoice`, `kode_customer`, `kode_tempat`, `nama_produk`, `qty`, `no_hp`, `status`, `tanggal`, `provinsi`, `kota`, `alamat`, `kode_pos`, `terima`, `tolak`, `cek`) VALUES
