...
<div class="container">
		<h2 style=" width: 100%; border-bottom: 4px solid #078209"><b>Manual Aplikasi</b></h2>
	<div class="bs-acc">
				...
				<div id="collapseOne" class="panel-collapse collapse in">
					<div class="panel-body">
						<ol>
							...
							<li>Pilih Map yang ingin disimpan</li>
							<li>Lihat dipenyimpanan</li>
						</ol>
					</div>
				</div>
			</div>
